...
let userNames = ["admin", "Fatima", "Safia", "Hira", "Fiaza"];
...
*/
let users = ["Fatima", "Maryam", "Faria", "Rabia", "Zenab"];
let newUsers = ["Ayesha", "Khadija", "Zahra", "Noor", "Sadia"];
