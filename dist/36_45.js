...
// Create three albums
const album1 = make_album(' Beyoncé', 'Lemonade');
const album2 = make_album('Kendrick Lamar', 'To Pimp a Butterfly', 12); // with number of tracks
...
const magician_names = ["David Copperfield", "Harry Houdini", "Penn Jillette", "Teller", "David Blaine"];
...
console.log("\nQuestion 43 \n");
const original_magicians = [...magician_names];
